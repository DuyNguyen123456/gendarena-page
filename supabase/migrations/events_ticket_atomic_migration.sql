-- ==============================================================================
-- Migration: Atomic Event Ticket Reservation & Capacity Lock (Phase 2)
-- File: supabase/migrations/events_ticket_atomic_migration.sql
-- ==============================================================================

-- 1. Function: Atomic Event Ticket Registration
-- Đảm bảo chống race condition, overselling và đếm vé chính xác tuyệt đối
...
BEGIN
  ...
  IF v_current_count >= v_event.total_tickets THEN
    RETURN jsonb_build_object(
      'success', false,
      'code', 'SOLD_OUT',
...
-- 2. Cấp quyền thực thi hàm cho service_role, authenticated và anon
